...
class Motivodeviaje(models.Model):
    id_motivo = models.CharField(primary_key=True, max_length=7)
    motivoviaje = models.CharField(max_length=100, blank=True, null=True)
...
class Pais(models.Model):
    id_pais = models.CharField(primary_key=True, max_length=7)
    paisesn = models.CharField(max_length=100, blank=True, null=True)
...
class Persona(models.Model):
    ...
    visa = models.CharField(max_length=256, blank=True, null=True)
    ...
    nombretutor = models.CharField(max_length=200, blank=True, null=True)
...
class Rol(models.Model):
    id_rol = models.CharField(primary_key=True, max_length=7)
...
class Usuarios(models.Model):
    ...
    contra = models.CharField(max_length=8, blank=True, null=True)
